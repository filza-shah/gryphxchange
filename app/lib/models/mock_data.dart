...
final List<Trade> mockTrades = <Trade>[
  ...
  Trade(
    ...
    offerType: OfferType.trade,
    tradeItemId: 'listing-6',
    tradeItem: mockListings[5],
    status: TradeStatus.pending,
    createdAt: DateTime.utc(2026, 2, 26, 16, 45),
  ),
  Trade(
    id: 'trade-5',
    listingId: 'listing-3',
    ...
    createdAt: DateTime.utc(2026, 2, 25, 11, 0),
  ),
  Trade(
    id: 'trade-6',
    listingId: 'listing-6',
    ...
    offerType: OfferType.trade,
    tradeItemId: 'listing-4',
    tradeItem: mockListings[3],
    status: TradeStatus.completed,
    createdAt: DateTime.utc(2026, 2, 24, 9, 30),
  ),
];
